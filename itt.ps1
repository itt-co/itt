...
'.Trim()  # Set the title text
            ...
            $itt.event.FindName('text').add_MouseLeftButtonDown({
                    Start-Process('link')  # Start the process to open the URL when clicked
                })
        ...
        <Grid Row="1" Background="Transparent" Margin="0">
            <ScrollViewer Name="ScrollViewer" VerticalScrollBarVisibility="Auto" Height="Auto">
                <StackPanel Margin="20" Orientation="Vertical">
                    <TextBlock Text=''= h2'' FontSize=''20'' Margin=''0,18,0,18'' FontWeight=''Bold'' Foreground=''{DynamicResource PrimaryButtonForeground}'' TextWrapping=''Wrap''/>
<TextBlock Text=''= description'' FontSize=''15'' Margin=''8''  Foreground=''{DynamicResource TextColorSecondaryColor2}''  TextWrapping=''Wrap''/>
<Image x:Name=''text'' Source=''jpg url'' Cursor=''Hand'' Margin=''0,0,0,0'' Height=''Auto'' Width=''400''/>
