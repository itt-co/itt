...
<Grid>
    ...
    <Menu Grid.Row="0" Grid.Column="0" Background="Transparent" BorderBrush="Transparent" HorizontalAlignment="Left" BorderThickness="0">
        ...
        <MenuItem Background="Transparent" BorderBrush="Transparent" BorderThickness="0" IsEnabled="False" ToolTip="Emad Adel">
            <MenuItem.Icon>
                <Image Source="https://raw.githubusercontent.com/emadadel4/ITT/main/static/Images/ps.png" Width="50" Height="Auto" Margin="5,5,0,0">
                    <Image.Effect>
                        <DropShadowEffect Color="#027a3d" BlurRadius="1" ShadowDepth="0" Opacity="0.5"/>
                    </Image.Effect>
                </Image>
            </MenuItem.Icon>
        </MenuItem>
