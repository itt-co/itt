...
<TextBlock Text=''Contribute and create your own theme, add your native language. favorite apps & music and more. Click on the image to see how to contribute.'' FontSize=''15'' Margin=''8''  Foreground=''{DynamicResource TextColorSecondaryColor2}''  TextWrapping=''Wrap''/>
