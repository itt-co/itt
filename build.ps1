...
function GenerateCheckboxes {
    ...
    foreach ($Item in $Items) {
        ...
        <StackPanel Orientation="Vertical" Margin="10">
            ...
            <TextBlock Width="600" Background="Transparent" Margin="8" Foreground="{DynamicResource TextColorSecondaryColor2}" FontSize="15" FontWeight="SemiBold" VerticalAlignment="Center" TextWrapping="Wrap" Text="$CleanedDescription."/>
        </StackPanel>
"@
    }
    return $Checkboxes
